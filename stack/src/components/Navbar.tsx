...
const Navbar = ({ handleslidein }: any) => {
  ...
  return (
    <div className=" top-0 z-50 w-full min-h-13.25 bg-white border-t-[3px] border-[#ef8236] shadow-[0_1px_5px_#00000033] flex items-center justify-center">
      <div className="w-[90%] max-w-360 flex items-center justify-between mx-auto py-1">
        <button
        ...
        <div className="flex items-center gap-2 grow">
          ...
          <form className="hidden lg:block grow relative px-3">
            <input
              type="text"
              placeholder="Search..."
              className="w-full max-w-150 pl-9 pr-3 py-2 text-sm border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-orange-300"
            />
